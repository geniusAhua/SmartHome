...
class Sensor:
    def __init__(self, nodeName):
        ...
        self.__ws = None
        self.__sensorType = "Air-conditioner"
        self.__status = "off"
    ...
    async def __respond_to_interest_with_data(self, packet, fileName, fromName, from_ws):
        if fileName == ".debug":
            ...
            await from_ws.send(SendFormat.send_(SendFormat.DATA, f"{packet}//{self.__status}"))
            return True
...
class Demo:
    def __init__(self):
        self.__nodeName = "Air-conditioner"
        self.__ndn = None
